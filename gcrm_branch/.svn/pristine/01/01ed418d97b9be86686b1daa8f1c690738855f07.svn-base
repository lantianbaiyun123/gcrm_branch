package com.baidu.gcrm.common.exception;
...
import com.baidu.gcrm.common.util.MessageHolder;

/**
 * 
 * @author anhuan
 * @email anhuan@baidu.com
 * @datetime 2012-7-12 下午4:03:33
 * 
 */
@WebFault
public class CRMWebServiceRuntimeException extends RuntimeException {

	private static final long serialVersionUID = -2469743944169364837L;
	private List<I18nMsg> errorMsgs = null;
	private I18nMsg errorMsg = null;
	/**
	 * 
	 */
	public CRMWebServiceRuntimeException() {
		super();
	}
	 ...
	 * @param varargs
	 */
	public CRMWebServiceRuntimeException(String key, Object... varargs) {
	 ...
	 * @param varargs
	 */
	public CRMWebServiceRuntimeException(Throwable cause, String key, Object... varargs) {
	 ...
	 * @param cause
	 */
	public CRMWebServiceRuntimeException(Throwable cause) {
		super(cause);
	}
