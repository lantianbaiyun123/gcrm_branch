...
@Service("defaultAssignmentByPositionHandler")
public class DefaultAssignmentByPositionHandler implements IAssignmentHandler {
    @Autowired
    ...
    private String[] getUserNamesByParticipantId(String participantId) {
        ...
        List<User> users = userRightsService.findUserByPosTag(participantId);
