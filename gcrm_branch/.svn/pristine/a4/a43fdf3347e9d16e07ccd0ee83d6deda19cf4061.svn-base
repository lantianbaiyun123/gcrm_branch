package com.baidu.gcrm.customer.vo;
...
public class CustomerI18nView {
	...
	private String belongsSales;
	private AgentRegional agentRegional;
	private Set<Country> agentCountry;
	private Customer agentCompany;
	...
	public String getBelongsSales() {
		return belongsSales;
	}
	public void setBelongsSales(String belongsSales) {
		this.belongsSales = belongsSales;
	}
}
