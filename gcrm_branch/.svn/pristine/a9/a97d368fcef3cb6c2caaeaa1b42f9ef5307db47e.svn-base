package com.baidu.gcrm.ad.material.model;
...
@Entity
@Table(name = "g_material_approve_record")
public class MaterialApprovalRecord implements BaseOperationModel {

    private static final long serialVersionUID = 216095435679457791L;
     ...
     * 审批记录对应的物料申请单号
     */
    @Column(name = "ad_material_apply_id")
    private Long adMaterialApplyId;
    ...
    public Long getAdMaterialApplyId() {
        return adMaterialApplyId;
    }

    public void setAdMaterialApplyId(Long adMaterialApplyId) {
        this.adMaterialApplyId = adMaterialApplyId;
    }
