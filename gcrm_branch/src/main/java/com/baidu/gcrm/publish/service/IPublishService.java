...
public interface IPublishService {
     ...
     * @return 上线单
     */
    Publish createPublish(AdSolutionContent content, Schedules schedule, String materialNumber);
    ...
    void updateAdSolutionNumberByAdContentIdIn(List<Long> adContentIds, String newAdSolutionNumber);
}
