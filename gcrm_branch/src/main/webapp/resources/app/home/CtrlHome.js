 ...
 */
define('_services/http/PersonalInfo',['app'],
function(app) {
...
define('_services/http/BenchmarkPrice',[
  'app'
], function (app) {
...
define('_services/http/Material',[
  'app'
], function (app) {
...
define("highcharts", ["angular","jquery"], function(){});

define('highcharts-ng',['app'], function (app) {


// angular.module('highcharts-ng', [])
app
// .factory('highchartsNGUtils', function () {
.registerFactory('highchartsNGUtils', function () {
  return {
...
define('notice/ServiceNoticeHttp',[
  'app'
], function (app) {
