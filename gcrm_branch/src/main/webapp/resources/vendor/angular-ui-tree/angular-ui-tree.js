...
(function () {
  ...
  app
    ...
    * angular-ui-tree.
    */
    .registerFactory('$uiTreeHelper', ['$document', '$window',
...
(function () {
  ...
  app
    ...
    .registerController('TreeController', ['$scope', '$element', '$attrs', 'treeConfig',
...
(function () {
  ...
  app
    ...
    .registerController('TreeNodesController', ['$scope', '$element', '$timeout', 'treeConfig',
...
(function () {
  ...
  app
    ...
    .registerController('TreeNodeController', ['$scope', '$element', '$attrs', 'treeConfig',
      function ($scope, $element, $attrs, treeConfig) {
        this.scope = $scope;
...
(function () {
  ...
  app
    ...
    .registerController('TreeHandleController', ['$scope', '$element', '$attrs', 'treeConfig',
      function ($scope, $element, $attrs, treeConfig) {
        this.scope = $scope;
...
(function () {
  ...
  app
  .registerDirective('uiTree', [ 'treeConfig', '$window',
...
(function () {
  ...
  app
  .registerDirective('uiTreeNodes', [ 'treeConfig', '$window',
    function(treeConfig) {
      return {
...
(function () {
  ...
  app
    ...
    .registerDirective('uiTreeNode', ['treeConfig', '$uiTreeHelper', '$window', '$document',
        ...
        return {
          ...
          link: function(scope, element, attrs, controllersArr) {
            ...
            var dragStartEvent = function(e) {
              //add drag exception for input element by-ccx
              //if (scope.dragEnabled() {
              if (scope.dragEnabled() && angular.lowercase(e.target.tagName) !== 'input') {
                dragStart(e);
              }
            };
...
(function () {
  ...
  app
  .registerDirective('uiTreeHandle', [ 'treeConfig', '$window',
    function(treeConfig) {
      return {
        require: '^uiTreeNode',
        restrict: 'A',
