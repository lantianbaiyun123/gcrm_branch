...
<div class="form-group">
    ...
    <div class="col-md-3">
        <input placeholder="请输入一个公司实体名称" type="text" class="form-control" id="companyName" name="companyName" data-required="true">
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-3 help-block">请选择客户类型</div>
</div>

<div class="form-group">
    <label class="control-label col-md-2" for="registerTime">注册时间：</label>
    <div class="col-md-3">
        <input type="text" class="form-control" id="registerTime" name="registerTime" placeholder="请输入注册时间(dd-mm-yyyy)" data-required data-pattern='^[0-9]{1,2}-[0-9]{1,2}-[0-9]{4}$'>
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <select class="form-control" name="agentCompany">
            <option value="互联网">互联网</option>
            <option value="互联网-视频">互联网-视频</option>
