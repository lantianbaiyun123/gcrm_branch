        ...
        <div class="container">   
            ...
            <div class="panel panel-default">
                <div class="panel-body">
	                <form class="form-horizontal" id="channelForm" action="<%=basePath%>position/saveChannel" method="post" role="form">
			            ...
			            <div class="form-group">
				            <div class="col-sm-offset-2 col-sm-10">
					           <button type="button" id="addChannel" class="btn btn-primary"><s:message code="view.save"/></button>
        ...
        <fis:script>
            $(document).ready(function(){
                ...
                $("#adPlatformId").change(function(){
                    ...
                    var baseQueryUrl = "<%=basePath%>site/queryByAdPlatform";
                    baseQueryUrl += "/"+currAdPlatformId;
                     $.post(baseQueryUrl,function(data){
                        $("#siteSelect").empty();
                        var optionHeml = "";
                        $.each( data, function(i, n){
                            optionHeml +="<option value='" + n.id + "'>" + n.i18nName + "</option>";
						});
						$("#siteSelect").html(optionHeml);
                     });
                });
                
                $("#addChannel").click(function(){
                    var currSiteId = $("#siteSelect option:selected").val();
                    if($.trim(currSiteId) == ''){
                        return false;
                    }else{
                        $("#channelForm").submit();
