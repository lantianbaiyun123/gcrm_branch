...
<table id="materialsTable" class="table table-gcrm">
    ...
    <tbody>
      	<c:forEach items="${attachments}" var="attachment" varStatus="attachmentStatus">
 			<c:choose>  
			<c:when test="${not empty attachment.url}"> 
				<tr>
	           	<td class="col-md-2">
				...
				<td>
					...
					<input id="attachments[${attachmentStatus.index}].exit" type="hidden" name="attachments[${attachmentStatus.index}].exit" value="true">
					<input id="attachments[${attachmentStatus.index}].customerNumber" type="hidden" name="attachments[${attachmentStatus.index}].customerNumber" value="${attachment.customerNumber}">
				...
				<td>
					<a id="attachments[${attachmentStatus.index}].deletePath" href="###" class="J_delMaterials"
						...
						data-url="${attachment.url}" data-id="${attachment.id}" data-tempUrl="${attachment.tempUrl}"><s:message code="materials.delete"/>
					</a>
				</td>
       		</tr>
			</c:when>
        ...
        <tr>
            <td class="col-md-2">
                <select id="typeSelect" class="form-control" name="attachments[${fn:length(attachments)}].type">
            ...
            <td class="col-md-3" style="padding-top: 0;">
                <span class="btn btn-link fileinput-button" style="color: #47a447;">
